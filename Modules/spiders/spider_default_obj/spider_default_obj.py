...
#=== Create record
     def save_new_post_to_db(self):
          if self.post_description not in [None, "N/A", "","None"]:
               self.parse_description(self.post_description)
